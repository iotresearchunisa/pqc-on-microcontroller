...
inline static void karatsuba_simple(const uint16_t *a_1, const uint16_t *b_1, uint16_t *result_final)
{
...
inline static void toom_cook_4way(const uint16_t *a1, const uint16_t *b1, uint16_t *result)
{
    ...
    BB0 = (uint16_t *)b1;
    BB1 = (uint16_t *)&b1[N_SB];
    BB2 = (uint16_t *)&b1[2 * N_SB];
    BB3 = (uint16_t *)&b1[3 * N_SB];
    ...
    delay(1); //Delay required for cpu to perform background operations
