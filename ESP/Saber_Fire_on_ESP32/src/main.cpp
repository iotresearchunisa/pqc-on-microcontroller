...
void setup()
{
    ...
    xTaskCreate(taskKeypair, "KeypairTask", 25000, NULL, 1, NULL);
    CLOCK2 = ESP.getCycleCount();

    CLOCK_kp = CLOCK2 - CLOCK1;

    CLOCK1 = ESP.getCycleCount();
    xTaskCreate(taskEncrypt, "EncryptTask", 25000, NULL, 1, NULL);
    CLOCK2 = ESP.getCycleCount();

    CLOCK_enc = CLOCK2 - CLOCK1;

    CLOCK1 = ESP.getCycleCount();
    xTaskCreate(taskDecrypt, "DecryptTask", 30000, NULL, 1, NULL);
    CLOCK2 = ESP.getCycleCount();

    CLOCK_dec = CLOCK2 - CLOCK1;

    xTaskCreate(taskVerify, "VerifyTask", 10000, NULL, 1, NULL);
