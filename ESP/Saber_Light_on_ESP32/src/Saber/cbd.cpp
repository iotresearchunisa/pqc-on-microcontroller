...
----------------------------------------------------------------------*/
/*
Questo codice implementa una funzione chiamata cbd (Canonic Binary Decoder) 
specifica per lo schema Saber KEM. Prende un array di byte buf contenente dati
 codificati e lo converte in un array di piccoli interi s.
*/
