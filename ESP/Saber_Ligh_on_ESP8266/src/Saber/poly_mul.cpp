...
static void karatsuba_simple(const uint16_t *a_1, const uint16_t *b_1, uint16_t *result_final) {
    // Dichiarare array statici per ridurre l'uso della memoria stack
    static uint16_t d01[KARATSUBA_N / 2 - 1];
    static uint16_t d0123[KARATSUBA_N / 2 - 1];
    static uint16_t d23[KARATSUBA_N / 2 - 1];
    static uint16_t result_d01[KARATSUBA_N - 1];
