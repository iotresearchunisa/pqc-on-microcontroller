...
/*
La funzione BS2POLq converte un array di byte (rappresentante un polinomio in forma compatta) in un array di interi a 16 bit 
(rappresentante un polinomio in forma estesa). 
*/
...
void BS2POLVECq(const uint8_t bytes[SABER_POLYVECBYTES], uint16_t data[SABER_L][SABER_N])
{
	...
	//Serial.println("End BS2POLVECq: poly_unpack \n");
}
