...
/*
        ...
        Serial.print(elapsedTime_test_nist_KAT/WORD_NUMBER);
        Serial.println("µs");
		Serial.print("Time enc: ");
        Serial.print(elapsedTime_encode/WORD_NUMBER);
        Serial.println("µs");
        Serial.print("Time sign: ");
        Serial.print(elapsedTime_sig/WORD_NUMBER);
        Serial.println("µs");
		Serial.print("Time verify sign: ");
        Serial.print(elapsedTime_vsig/WORD_NUMBER);
        Serial.println("µs");
        Serial.println("");
*/
...
const int WORD_NUMBER=25;
 uint8_t parole_in_array[25][10] = {
...
//const uint8_t (*ptr)[10] = parole_in_array; // Puntatore a un array di 10 elementi (parola)
